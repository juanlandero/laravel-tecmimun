...
<div style="width: 100%;
    ...
    <p style="height: 80%; width: 100%; text-align: center;">
        <img src="{{ asset('img/logo-blanco.png') }}" alt="Logo" style="height: 60%;">
    </p>
    <br>
    <div style="width: 100%;">
        <h1 style="
...
<div  style="margin: 0px 10%">
    ...
    <p style="font-size: 1.5em;text-align: justify; color:#4a4a4a">
        Este correo es para confirmar el registro del colegio <span style="color:#01579b">{{ $data->nombre }}</span>, como un participante mas de nuestro Modelo de Naciones Unidas.
    </p>
    <p style="font-size: 1.5em;text-align: justify; color:#4a4a4a">
...
<div style="width: 100%;
    ...
    <a style="margin: auto;
            ...
            color: #78a42e;"  href="www.tecmimun.com" >
